...
import json
from tkinter import *
from chat_1 import get_response_1, bot_name
...
class ChatApplication:
    ...
    def run(self):
        a="Kelly: Hey buddy! Welcome to APNA app. I understand you belong to 10-20 age group. I am your personal chatbot. I'm here to help you de-stress and nurture yourself. How can I assist you today?"
        print(a)
    ...
    def _insert_message(self, msg, sender):
        ...
        msg2 = f"{bot_name}: {get_response_1(msg)}\n\n"
        self.text_widget.configure(state=NORMAL)
    ...
    # Load existing conversation data
        try:
            with open('conversation1.json', 'r') as json_file:
    ...
    # Save the combined data to the JSON file
        with open('conversation1.json', 'w') as json_file:
